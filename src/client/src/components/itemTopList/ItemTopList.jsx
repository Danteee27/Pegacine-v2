...
export default function ItemTopList({index, top = index+1}) {
        ...
        <Link to={{pathname: '/player', movie: movie}}>
            ...
            >
                <div className={"itemContainer"}>
                    ...
                    { top==2 &&
                        <svg ref={indexSvg} id="rank-2" width="100%" height="100%" viewBox="0 0 80 154"
                    ...
                    { top==3 &&
                        <svg ref={indexSvg} id="rank-3" width="100%" height="100%" viewBox="0 0 80 154"
                    ...
                    { top==4 &&
                        <svg ref={indexSvg} id="rank-4" width="100%" height="100%" viewBox="0 0 81 154"
                    ...
                    { top==5 &&
                        <svg ref={indexSvg} id="rank-5" width="100%" height="100%" viewBox="0 0 81 154"
                    ...
                    { top==6 &&
                        <svg ref={indexSvg} id="rank-6" width="100%" height="100%" viewBox="0 0 81 154"
                    ...
                    { top==7 &&
                        <svg ref={indexSvg} id="rank-7" viewBox="0 0 78 154" width="100%" height="100%"
                    ...
                    { top==8 &&
                        <svg ref={indexSvg} id="rank-8" width="100%" height="100%" viewBox="0 0 77 154"
                    ...
                    { top==9 &&
                        <svg ref={indexSvg} id="rank-9" viewBox="0 0 71 154" width="100%" height="100%"
                    ...
                    { top==10 &&
                        <svg ref={indexSvg} id="rank-10" width="100%" height="100%" viewBox="0 0 140 154"
